...
Exercise 1 (Make the queue thread-safe) The implementation of the queue is not threadsafe. Two threads working on the queue at the same time could make it fail. Change the queue so
